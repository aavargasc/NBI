...
#==============================================================================#
# EXPORTAR RESULTADOS# 
final_data <- per_viv[, c("id_upm", "id_vivienda", "id_hogar", "id_persona",
                          "fexp", "estrato", "conglomerado", "ciudad", "hogar", 
                          "mes", "area", "per_por_hog", "dim1", "dim2", "dim3", 
                          "dim4", "dim5", "dimk", "knbi", "nbi")]


ruta <- "E:/Andres/NBI/Resultados_excel"

write_xlsx(list("Datos" = final_data, "Resultados" = resultados), file.path(ruta, "NBI.xlsx"))

saveRDS(final_data, file.path(ruta, "NBI.rds")) 
saveRDS(resultados, file.path(ruta, "resultados.rds"))
